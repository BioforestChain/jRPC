...
export declare type EndpointEventListenerOrEventListenerObject = ((ev: MessageEvent) => unknown) | {
...
export interface RawListWireValue {
    id?: string;
    type: WireValueType.RAW_ARRAY;
    value: WireValue[];
}
...
export declare type WireValue = RawWireValue | RawListWireValue | HandlerWireValue;
